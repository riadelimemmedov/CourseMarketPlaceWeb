...
#?Pydantic shmecas
ProfileBaseSchema = pydantic_model_creator(Profile,name='ProfileBaseSchema',exclude=['username','profile_image','user_role','city','email'],exclude_readonly=True)#For creating new profile
ProfileOutSchema = pydantic_model_creator(Profile,name='ProfileOut',exclude=['date_joined','modified_at'])#For retrieve profile information to client modified format
