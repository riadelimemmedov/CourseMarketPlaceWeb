...
from managers.auth.jwthandler import (
    create_access_token,
    get_current_user,
...
@router.get(
    "/profiles",
    response_model=List[(ProfileOutSchema)],
...
@router.get(
    "/profile/whoami",
    response_model=ProfileOutSchema,
...
async def delete_user(
    profile_id: int, current_profile: ProfileOutSchema = Depends(get_current_user)
) -> Status:
