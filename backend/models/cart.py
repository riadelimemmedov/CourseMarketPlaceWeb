...
class CartItem(models.Model):
    profile = fields.ForeignKeyField(
        "models.Profile",
        related_name="profile_cart_item",
        on_delete=fields.CASCADE,
        null=True,
    )
    course = fields.ForeignKeyField(
        "models.Course", related_name="course_cart_item", on_delete=fields.CASCADE
    )
    cart = fields.ForeignKeyField(
        "models.Cart", related_name="cart_data", on_delete=fields.CASCADE, null=True
    )
